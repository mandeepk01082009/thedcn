    ...
    <div class="container-fluid mt-5">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('ourpacks') }}"><button class="btn btn-primary" style="float:right;">Add</button></a><br><br>
                                ...
                                @foreach ($image as $key => $images)  
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="/editpacks/{{ $images->id }}" class="btn btn-info btn-sm waves-effect">
                                                <i class="material-icons">Edit</i>
                                            </a>
                                            <a href="/deletepacks/{{ $images->id }}"    
