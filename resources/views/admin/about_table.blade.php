    ...
    <div class="container-fluid mt-5">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('ab') }}"><button class="btn btn-primary" style="float:right;">Add</button></a><br><br>
                                ...
                                @foreach ($image as $key => $images)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="/editabout/{{ $images->id }}" class="btn btn-info btn-sm waves-effect">
                                                <i class="material-icons">Edit</i>
                                            </a>
                                            <a href="/deleteabout/{{ $images->id }}"  
