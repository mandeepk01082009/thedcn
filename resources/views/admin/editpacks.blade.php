    ...
    <div class="row clearfix">
        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 mx-5">
            <div class="card p-3">
                ...
                <div class="body">
                    <form action="/updatepacks/{{ $packs->id }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')               
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                <label for="image" class="col-md-4 col-form-label">Name of Pack</label>
                        ...
                        <button type="submit" class="btn btn-primary mt-2"> Edit Pack </button>
